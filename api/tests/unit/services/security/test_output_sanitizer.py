...
class TestCredentialDetection:
    ...
    def test_detects_github_token(self, sanitizer):
        ...
        # Built at runtime so push-protection scanners do not flag the fixture.
        fake_token = "gh" + "p_" + ("1234567890abcdef" * 2) + "1234"
    ...
    def test_detects_stripe_key(self, sanitizer):
        ...
        # Built at runtime so push-protection scanners do not flag the fixture.
        fake_key = "sk_" + "live_" + ("1234567890abcdef" * 2)
        content = f"Stripe key: {fake_key}"
        result = sanitizer.sanitize(content)
    ...
    def test_detects_slack_token(self, sanitizer):
        ...
        # Built at runtime so push-protection scanners do not flag the fixture.
        fake_token = "xox" + "b-" + "1234567890-1234567890-" + ("abcd" * 6)
        content = f"Token: {fake_token}"
        result = sanitizer.sanitize(content)
